...
// Initial mock data
const initialDonationsData: DonationData[] = [
  {
    id: 1,
    name: "Rahul Kadam",
    title: "Offering help for cancer treatment",
    description: "I want to support families battling cancer. My donation will help cover treatment costs for those in need.",
    imageUrl: "/pills.jpg",
    avatarUrl: "/admin.jpg",
    initials: "RK",
    isVerified: true,
  ...
  },
  {
    ...
    description: "I'm committing funds to help cover heart surgeries for those who can't afford them.",
  ...
  },
  {
    ...
    description: "I'm establishing a fund to support individuals needing lifelong medical care.",
    avatarUrl: "/placeholder.svg",
    initials: "RJ",
    isVerified: true,
