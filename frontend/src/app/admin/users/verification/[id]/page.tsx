  ...
  useEffect(() => {
    const fetchVerificationData = async () => {
      try {
        ...
        // If verification is already processed, set notes from the response
        ...
        <div className="flex min-h-screen w-full overflow-x-hidden">
          ...
          <div className="flex-1 w-full min-w-0 flex flex-col">
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          disabled={submitting || verification.isProcessed}
                           readOnly={verification.isProcessed}
                        />
                      </div>
            ...
            <div className="mb-6">
              ...
              {verification.isProcessed ? (
                <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${verification.status === 'approved' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                  <span className="mr-1">
