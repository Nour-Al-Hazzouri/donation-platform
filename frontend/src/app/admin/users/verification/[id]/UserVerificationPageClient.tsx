...
export function UserVerificationPageClient({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleApprove = async () => {
    ...
    console.log(`Approving verification request with notes: ${notes}`)
  ...
  const handleDecline = async () => {
    ...
    console.log(`Declining verification request with notes: ${notes}`)
              ...
              <div className="space-y-6 h-full">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{VERIFICATION_REQUEST.personalDetails.gender}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">
                      {VERIFICATION_REQUEST.personalDetails.address.district} {VERIFICATION_REQUEST.personalDetails.address.street} {VERIFICATION_REQUEST.personalDetails.address.governorate} {VERIFICATION_REQUEST.personalDetails.address.city}
                    </p>
                  </div>
                </div>
              </div>
