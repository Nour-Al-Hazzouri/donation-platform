    ...
    return (
      <MainLayout>
        <div className="max-w-2xl mx-auto px-4 py-8 text-center">
          ...
          <p className="text-muted-foreground">Please wait while we load the request details.</p>
        </div>
      </MainLayout>
    )
  }
    ...
    return (
      <MainLayout>
        <div className="max-w-2xl mx-auto px-4 py-8 text-center">
          ...
          <Button onClick={() => router.push('/')} className="mt-4">Back to Requests</Button>
        </div>
      </MainLayout>
    )
  }
  ...
  />
            ...
            {pendingTransactions.length > 0 && (
              <div className="mt-6 bg-yellow-50 border border-yellow-400 p-4 rounded-lg">
                <h4 className="font-medium text-yellow-800 mb-2">Your Pending Donations</h4>
