...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      {...props}
    >
      {showIcon && <div className="size-4 rounded-md bg-gray-200 animate-pulse" data-sidebar="menu-skeleton-icon" />}
      <div
        className="h-4 flex-1 bg-gray-200 animate-pulse rounded"
