    ...
    <section className="w-full bg-white pt-2 pb-6 sm:pt-3 sm:pb-8 md:pt-4 md:pb-10 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-16" id="about-us">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="w-full text-center mb-1 sm:mb-2">
          <h2 className="text-2xl xs:text-2.5xl sm:text-3xl md:text-4xl font-bold text-gray-900 leading-tight">
            About us
          </h2>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto mt-0 sm:mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
          ...
          <div className="space-y-3 sm:space-y-4 md:space-y-5 order-2 md:order-1">
            <div>
              <h3 className="text-xl sm:text-1.5xl md:text-2xl font-semibold text-gray-800 mb-1 sm:mb-2">
                The Lebanese Way of Sharing
              </h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 sm:mb-3">
              ...
              <p className="text-xs sm:text-sm text-gray-700 font-semibold">What Makes Us Different</p>
              <ul className="mt-1 space-y-2 sm:space-y-3">
                <li className="flex items-start gap-2 sm:gap-3">
                  <Handshake className="w-4 h-4 sm:w-5 sm:h-5 text-gray-800 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 text-sm sm:text-base">Direct Aid: Your donation reaches hands, not warehouses.</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <Users className="w-4 h-4 sm:w-5 sm:h-5 text-gray-800 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 text-sm sm:text-base">Community-Powered: Every post and need is verified by locals.</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <Heart className="w-4 h-4 sm:w-5 sm:h-5 text-gray-800 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 text-sm sm:text-base">For All Lebanese: No sides, no sects, just humanity helping humanity.</span>
                </li>
              </ul>
            </div>
